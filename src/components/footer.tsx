...
const Footer = () => {
  ...
  return (
    <footer className="flex flex-col justify-center items-center gap-6 backdrop-blur-md">
      <div className="flex flex-col items-center text-slate-800 text-sm">
        ...
        <span className="mt-2 text-xs">&copy; 2024 Michael Jung</span>
      </div>
    </footer>
  );
};
